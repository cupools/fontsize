...
var fontsize = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(opts, root) {
  ...
  return function fontsize(_x, _x2) {
...
function process(text, item) {
  ...
  return new _promise2.default(function (resolve, reject) {
    new _fontmin2.default().src(realpath).use(_fontmin2.default.otf2ttf()).use(_fontmin2.default.glyph({
      text: text,
      hinting: false
