...
var fontsize = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
    ...
    var _proof, resolveUrl, text, storage, supply, targets;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return _promise2.default.all(targets.map(process));
...
var process = function () {
  var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(item) {
    var realpath, decl, text, result;
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            realpath = item.realpath, decl = item.decl, text = item.text;
            _context2.next = 3;
          ...
          case 3:
            ...
            decl.value = decl.value.replace(/url\(["']?([\w\W]+?)["']?\)/, 'url(\'data:application/x-font-ttf;charset=utf-8;base64,' + result + '\')');
